...
#define GTPROXY_REMOVE_EVENT_NAME(cb_type) Remove##cb_type
...
namespace event_manager
{
    ...
    GTPROXY_REMOVE_EVENT_DECLARE(OnReceiveTankPacket);
    ...
    GTPROXY_REMOVE_EVENT_DECLARE(OnReceiveRawPacket);
    ...
    GTPROXY_REMOVE_EVENT_DECLARE(OnReceiveVariantlist);
    ...
    GTPROXY_REMOVE_EVENT_DECLARE(OnSendRawPacket);
    ...
    GTPROXY_REMOVE_EVENT_DECLARE(OnSendTankPacket);
    ...
    GTPROXY_REMOVE_EVENT_DECLARE(OnSendVariantlist);
